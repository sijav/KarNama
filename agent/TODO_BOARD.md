...
**Next up: `KN-120` Make schema.gql a checked build artefact rather than a side effect of starting the server** (critical, 3 pt, api)
...
- **status** review · **severity** critical · **points** 3 · **area** api
- **blocked by** KN-033
