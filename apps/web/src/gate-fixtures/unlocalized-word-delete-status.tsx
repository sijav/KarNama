...
export const DeleteStatusAsLabel = () => <IconButton aria-label="حذف وضعیت" />
export const DeleteStatusAsTitle = () => <Box title="حذف وضعیت" />
export const DeleteStatusAsText = () => <Box>حذف وضعیت</Box>
