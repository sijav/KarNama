...
export const messages: Record<string, string> = {
  ...
  'Add 30 fictional jobs and 6 contacts to test the app. Your existing records are kept; repeated loads do not add duplicates.': 'Add 30 fictional jobs and 6 contacts to test the app. Your existing records are kept; repeated loads do not add duplicates.',
  'Sample data loaded. Open your board or network to explore it.': 'Sample data loaded. Open your board or network to explore it.',
  ...
  'Cedar Studio (sample)': 'Cedar Studio (sample)',
  'Blue Kite (sample)': 'Blue Kite (sample)',
  'Maple Labs (sample)': 'Maple Labs (sample)',
  'Tehran': 'Tehran',
  'Isfahan': 'Isfahan',
  'Fictional job for testing. Work with a small team, review requirements, deliver improvements, and share progress each week. This is not a real vacancy.': 'Fictional job for testing. Work with a small team, review requirements, deliver improvements, and share progress each week. This is not a real vacancy.',
  '2 to 4 years': '2 to 4 years',
  'Negotiable': 'Negotiable',
  'Sample data': 'Sample data',
  'Sample note: review the role and prepare questions before following up.': 'Sample note: review the role and prepare questions before following up.',
  'Alex (sample)': 'Alex (sample)',
  'Sam (sample)': 'Sam (sample)',
  'Robin (sample)': 'Robin (sample)',
  'Taylor (sample)': 'Taylor (sample)',
  'Jamie (sample)': 'Jamie (sample)',
  'Casey (sample)': 'Casey (sample)',
  'Recruiter': 'Recruiter',
  ...
  'Sign in to KarNama': 'Sign in to KarNama',
  'Write your mobile number': 'Write your mobile number',
  ...
  'No message is really sent yet. Your code is:': 'No message is really sent yet. Your code is:',
  'That code has expired. Ask for another one.': 'That code has expired. Ask for another one.',
  'That code is not right. Try again.': 'That code is not right. Try again.',
