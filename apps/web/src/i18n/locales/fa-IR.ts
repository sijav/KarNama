...
export const messages: Record<string, string> = {
  ...
  Light: 'روشن',
  Dark: 'تیره',
  'Use device setting': 'مطابق دستگاه',
  Done: 'تمام',
  'Load sample data': 'بارگذاری داده‌های نمونه',
  'Add 30 fictional jobs and 6 contacts to test the app. Your existing records are kept; repeated loads do not add duplicates.':
    '۳۰ فرصت شغلی ساختگی و ۶ مخاطب برای آزمایش برنامه اضافه کن. اطلاعات فعلی‌ات حفظ می‌شود و بارگذاری دوباره مورد تکراری اضافه نمی‌کند.',
  'Sample data loaded. Open your board or network to explore it.':
    'داده‌های نمونه بارگذاری شد. برای دیدن آن‌ها به فرصت‌های شغلی یا شبکه ارتباطی برو.',
  ...
  'Mobile developer': 'توسعه‌دهنده موبایل',
  'DevOps engineer': 'مهندس دواپس',
  'UX researcher': 'پژوهشگر تجربه کاربری',
  'Customer support specialist': 'کارشناس پشتیبانی مشتریان',
  'Cedar Studio (sample)': 'استودیو سرو (نمونه)',
  'Blue Kite (sample)': 'بادبادک آبی (نمونه)',
  'Maple Labs (sample)': 'آزمایشگاه افرا (نمونه)',
  Tehran: 'تهران',
  Isfahan: 'اصفهان',
  'Fictional job for testing. Work with a small team, review requirements, deliver improvements, and share progress each week. This is not a real vacancy.':
    'فرصت شغلی ساختگی برای آزمایش. با تیمی کوچک همکاری کن، نیازمندی‌ها را بررسی کن، بهبودها را انجام بده و هر هفته پیشرفت کار را به اشتراک بگذار. این آگهی واقعی نیست.',
  '2 to 4 years': '۲ تا ۴ سال',
  Negotiable: 'توافقی',
  'Sample data': 'داده‌های نمونه',
  'Sample note: review the role and prepare questions before following up.':
    'یادداشت نمونه: پیش از پیگیری، شرح نقش را بررسی کن و پرسش‌هایت را آماده کن.',
  'Alex (sample)': 'الکس (نمونه)',
  'Sam (sample)': 'سام (نمونه)',
  'Robin (sample)': 'رابین (نمونه)',
  'Taylor (sample)': 'تیلور (نمونه)',
  'Jamie (sample)': 'جیمی (نمونه)',
  'Casey (sample)': 'کیسی (نمونه)',
  Recruiter: 'کارشناس جذب نیرو',
  ...
  'Automatic extraction is unavailable. You can enter the details yourself.':
    'استخراج خودکار در دسترس نیست. می‌توانی اطلاعات را دستی وارد کنی.',
  ...
  'Nothing matches this search. Try other words or remove the filters.':
    'چیزی با این عبارت پیدا نشد. عبارت دیگری امتحان کن یا فیلترها را بردار.',
  ...
  'job opportunities; to delete it, first move them to another column.':
    'فرصت شغلی داره؛ برای حذفش اول باید فرصت‌های شغلی رو ببری یه ستون دیگه.',
  ...
  'Delete these contacts?': 'این مخاطب‌ها حذف شوند؟',
  ...
  'Delete these job opportunities?': 'این فرصت‌های شغلی حذف شوند؟',
  'This job opportunity is deleted for good and cannot be brought back.': 'این فرصت شغلی برای همیشه حذف می‌شود و برگشتی ندارد.',
  'job opportunities are deleted for good and cannot be brought back.': 'فرصت شغلی برای همیشه حذف می‌شود و برگشتی ندارد.',
  'Edit contact': 'ویرایش مخاطب',
  'Full name': 'اسم و فامیل',
  'e.g. Sara Mohammadi': 'مثلاً: سارا محمدی',
  Role: 'سمت',
  'e.g. HR specialist': 'مثلاً: کارشناس منابع انسانی',
  Company: 'شرکت',
  'e.g. Digikala': 'مثلاً: دیجی‌کالا',
  Email: 'ایمیل',
  Phone: 'شماره تماس',
  '0912 000 0000': '۰۹۱۲ ۰۰۰ ۰۰۰۰',
  'Social link': 'لینک شبکه اجتماعی',
  'Related job opportunity': 'فرصت شغلی مربوطه',
  ...
  'Sign out': 'خروج',
  Workspace: 'فضای کار',
  'We could not read the posting': 'نشد آگهی را بخوانیم',
  'Posting link or full text': 'لینک آگهی یا متن کامل آگهی',
  'Paste the posting link, or copy the whole posting text here': 'لینک آگهی را بچسبان، یا کل متن آگهی را اینجا کپی کن',
  'It takes a link or the whole posting text; you do not need to separate anything.':
    'هم لینک را می‌پذیرد، هم متن کامل آگهی را — لازم نیست چیزی را جدا کنی.',
  'We could not read this link.': 'نتوانستیم اطلاعات این لینک را بخوانیم.',
  'The posting may have been removed or the site may not allow reading it.': 'شاید آگهی حذف شده یا سایت اجازه‌ی خواندن نمی‌دهد.',
  'Try again, or enter the details yourself.': 'دوباره تلاش کن، یا اطلاعات را دستی وارد کن.',
  'No link or posting text?': 'لینک یا متن آگهی نداری؟',
  'Enter it yourself': 'خودت دستی وارد کن',
  'Try again': 'دوباره امتحان کن',
  'Extract details': 'استخراج اطلاعات',
  'Close without saving?': 'بدون ذخیره بسته شود؟',
  'What you entered here will not be kept.': 'هر چی اینجا وارد کردی نگه داشته نمی‌شه.',
  ...
  'Posting link': 'لینک آگهی',
  'Job description and responsibilities': 'شرح شغل و مسئولیت‌ها',
  'Required skills': 'مهارت‌های موردنیاز',
  Automatic: 'خودکار',
  Manual: 'دستی',
  'Last edited:': 'آخرین ویرایش:',
  Download: 'دانلود',
  'Drop a file here': 'فایل را اینجا رها کن',
  'Choose file': 'انتخاب فایل',
  KB: 'کیلوبایت',
  MB: 'مگابایت',
  'The Language toolbar could not be read, so this page is in Persian until the toolbar is changed.':
    'زبانِ نوار ابزار Language خوانده نشد، پس این صفحه تا وقتی نوار ابزار عوض نشود فارسی است.',
  'Sign in to KarNama': 'ورود به کارنما',
  'Write your mobile number': 'شماره موبایلت را وارد کن',
  ...
  'Change the number': 'ویرایش شماره',
  'No message is really sent yet. Your code is:': 'هنوز پیامکی واقعاً ارسال نمی‌شود. کدت این است:',
  'That code has expired. Ask for another one.': 'این کد منقضی شده. یک کد دیگر بگیر.',
  'That code is not right. Try again.': 'این کد درست نیست. دوباره امتحان کن.',
  ...
  'Confirm and sign in': 'تأیید و ورود',
  Welcome: 'خوش آمدی',
  'Just tell us your name so we can build your job opportunities board.': 'فقط اسمت را بگو تا برد فرصت‌های شغلی‌ات را بسازیم.',
  'First and last name': 'نام و نام خانوادگی',
  'Mehdi Rezaei': 'مهدی رضایی',
  'Write your first and last name': 'نام و نام خانوادگی‌ات را بنویس',
  Start: 'شروع کن',
  'This contact is deleted for good and cannot be brought back.': 'این مخاطب برای همیشه حذف می‌شود و برگشتی ندارد.',
  'contacts are deleted for good and cannot be brought back.': 'مخاطب برای همیشه حذف می‌شوند و برگشتی ندارند.',
}
